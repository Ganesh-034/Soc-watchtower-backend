...
export const getIncidentsHandlingStatus = async () => {
  try {
    ...
    const result = {
      customerName,
      months: [
        { id: currentMonthId, name: currentMonthName, period: "Current Month", statuses: { Open: 0, Pending: 0, Resolved: 0, Closed: 0 } },
        { id: previousMonthId, name: previousMonthName, period: "Previous Month", statuses: { Open: 0, Pending: 0, Resolved: 0, Closed: 0 } },
        { id: twoMonthsAgoId, name: twoMonthsAgoName, period: "Two Months Ago", statuses: { Open: 0, Pending: 0, Resolved: 0, Closed: 0 } }
      ]
    };
    ...
    console.error('Error in getIncidentStatusCounts:', error);
    throw new Error('Error fetching incident status counts: ' + error.message);
  }
}