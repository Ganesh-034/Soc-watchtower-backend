...
export const getIncidentsSubStatus = catchAsync(async (req, res) => {
  ...
  const incidentSSCounts = await incidentSSService.getIncidentsSubStatus(month);
  res.json(new ApiResponse(200, incidentSSCounts, "Incident counts by Sub Status fetched successfully"));
});